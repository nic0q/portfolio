  ...
  return (
    <div id="aboutMe" className="bg-gray-900 w-full text-gray-300 h-screen">
      <div className="max-w-[1000px] mx-auto p-4 sm:pt-20 flex flex-col w-full">
        ...
        <br></br>
        <p className="text-gray-300 text-2xl font-bold inline">Academic Degree</p>
        <p>I've obtain the Bachelor of Science in Engineering Degree at Universidad de Santiago de Chile in 2024.</p>  
        <br></br>
        <p className="text-gray-300 text-2xl font-bold inline">Languages</p>
        ...
        <br></br>
        <p className="text-gray-300 text-2xl font-bold inline">My Journey</p>
        ...
        {/* <br></br>
        <p className="text-white text-2xl font-bold inline">What I am doing now?</p>
        <p>
